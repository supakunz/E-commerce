...
const Dashboard = () => {
  ...
  // Function to calculate category percentage in JavaScript
  function calculateCategoryPercentage(data) {
    ...
    const categoryPercentage = Object.keys(categoryCounts).reduce(
      (percentages, category) => {
        percentages[category] = Number(
    ...
    return setCartData(categoryPercentage);
  }

  useEffect(() => {
    calculateCategoryPercentage(all_product);
  }, [all_product]);
